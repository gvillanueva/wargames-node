 ...
 * @param {String} authToken sha256 hash representing an authenticated client.
 * @param {Object} callback Connection to calling client.
 */
...
/**
 * Sends a chat message to the clients of the game.
 * @param user {Object} The user sending the message.
 * @param message {Object} The content of the message.
 * @param callback {Object} Connection to calling client.
 */
...
/**
 * Moves a unit within the game.
 * @param user {Object} The user moving the unit.
 * @param unit {Object} The unit to be moved.
 * @param move {Object} The new location of the unit.
 * @param callback {Object} Connection to calling client.
 */
Game.prototype.move = function(user, unit, move, callback) {
    ...
    try {
        ...
        this.emit('event', 'moved', { unit: unit, move: move });
        callback(null, true);
    }
    catch (e) {
