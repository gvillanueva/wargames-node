...
/**
 * Validates whether the given authentication token is valie.
 * @param authToken {String} String to look up in user keys.
...
/**
 * Returns the name of the user matching the authentication token.
 * @param authToken {string} String to look up in user keys.
 * @returns {String} Name of the user, if found. Otherwise, null.
 */
exports.getName = function(authToken) {
    return users[authToken].name;
}
        ...
        connection.connect(function (err) {
            ...
            connection.query(
                ...
                [user.name], function (err, rows, fields) {
                    ...
                    log.verbose(__filename, "user authenticated: " + user.name);
